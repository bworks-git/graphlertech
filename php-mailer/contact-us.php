...
<head>
   ...
   <meta name="description" content="Graphler is an engineering consulting firm providing perfectly structured CAE solutions for Industries">
    <meta name="keywords" content="engineering consulting,CAE,CAD,CAM,Coimbatore,Mechanical">     
    <meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1,user-scalable=no">
	<title>Contact us Graphlertech</title>
								  ...
								  $message = test_input($_POST["message"]);
									...
									/* More about project start */ 
										...
										{  
											...
											$tmpName  = $_FILES['fileToUpload']['tmp_name'][0];
											...
											$img_ex  = explode(".",strrev($_FILES['fileToUpload']['name'][0]));
											$img_ext = strrev($img_ex[0]);
											$image_name =  $name.".".$img_ext;
											$image_type = $_FILES['fileToUpload']['tmp_name'][0];
